---
name: determine_threat_model
description: Build a threat model for the repository or component to identify entry points, trust boundaries, sensitive data paths, attack surfaces, and priority review areas.
aliases:

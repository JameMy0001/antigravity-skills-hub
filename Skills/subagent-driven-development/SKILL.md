...
description: Use when executing implementation plans with independent tasks in the current session - dispatches fresh implementer subagent per task with rigorous task-level reviews.
aliases:
...
- [[Skills/writing-plans/SKILL|writing-plans]] — สร้าง Implementation Plan ที่แบ่งเป็น Task ย่อย

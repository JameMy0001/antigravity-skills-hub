...
description: "4-phase root cause debugging: understand bugs before fixing, reproduce reliably, isolate failure conditions, and implement surgical fix with verification."
aliases:
...
- [[Skills/orch-fix-defect/SKILL|orch-fix-defect]] — กรอบการทำงานหลักสำหรับการแก้บักและควบคุมคุณภาพ
